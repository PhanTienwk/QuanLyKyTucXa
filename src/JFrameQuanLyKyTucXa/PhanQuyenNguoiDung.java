...
public class PhanQuyenNguoiDung extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        ComboBoxPhanQuyen.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "USER", "ADMIN" }));
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addComponent(ScrollPaneSV, javax.swing.GroupLayout.PREFERRED_SIZE, 283, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(135, 135, 135))
        );
    ...
    private void txtSearchKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtSearchKeyReleased
        ...
        if (txtSearch.isSelected()) {
            ...
            if (option == 0) {
                showTableSV("maSV", textsearch);
            } else if (option == 1) {
                showTableSV("tenSV", textsearch);
            } else if (option == 2) {
    ...
    void AddComboBoxDelete() {
        Connection conn = KetNoiSQL.getConnection();
        String sql = "select * from thongtintaikhoan where phanQuyen='ADMIN'";
    ...
    void AddSearch() {
        ...
        txtSearch.addOption(new SearchOption("mã sinh viên", new ImageIcon(getClass().getResource("/img/user.png"))));
        txtSearch.addOption(new SearchOption("tên sinh viên", new ImageIcon(getClass().getResource("/img/user.png"))));
